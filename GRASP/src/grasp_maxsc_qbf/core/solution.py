...
class Solution(Generic[E]):
    ...
    def __str__(self):
        return f"Solution: cost=[{self.value}], size=[{len(self.elements)}], elements={sorted(self.elements)}"